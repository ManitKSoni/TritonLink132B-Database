		...
		<table>
			<tr>
				...
				if (action != null && action.equals("update")) {
					...
					PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE academic_history SET GRADE = ?, UNITS = ? WHERE SECTION_ID = ? AND YEAR = ? AND QTR = ? AND COURSE_ID = ? AND STUDENT_ID = ?");
					...
					pstmt.setString(6, request.getParameter("COURSE_ID"));
				...
				if (action != null && action.equals("delete")) {
					...
					PreparedStatement pstmt = conn.prepareStatement(
					"DELETE FROM academic_history WHERE SECTION_ID = ? AND YEAR = ? AND QTR = ? AND COURSE_ID = ? AND STUDENT_ID = ?");
