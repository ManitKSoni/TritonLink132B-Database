		...
		<table>
			<tr>
				...
				if (action != null && action.equals("insert")) {
					...
					("INSERT INTO enroll_list VALUES (?,?,?,?)"));
					
					pstmt.setInt(1, Integer.parseInt(request.getParameter("ENROLL_LIST_ID")));
				...
				if (action != null && action.equals("update")) {
					...
					PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE enroll_list SET GRADE = ?, UNITS = ? WHERE ENROLL_LIST_ID = ? AND STUDENT_ID = ?");
				...
				if (action != null && action.equals("delete")) {
					...
					PreparedStatement pstmt = conn.prepareStatement(
					"DELETE FROM enroll_list WHERE ENROLL_LIST_ID = ? AND STUDENT_ID = ?");
				...
				ResultSet rs = statement.executeQuery("SELECT * FROM enroll_list");
				%>
				...
				<table>
					...
					<tr>
						<form action="enroll_list.jsp" method="get">
				...
				%>
					<tr>
						...
						<form action="enroll_list.jsp" method="get">
							...
							<input type="hidden" value="<%= rs.getInt("ENROLL_LIST_ID") %>" name="ENROLL_LIST_ID">
